...
model SixBranchesEvapThreeBranchsSH_Turbine

  extends ClaRa.Basics.Icons.PackageIcons.ExecutableExample100;

  import Modelica.Constants.pi;

  //parameter String path=Modelica.Utilities.System.getEnvironmentVariable("ClaRa_Solar_git") + "/Clara_Solar_InputData/InputIrradiation/" "Path of radiation data" annotation(Dialog(group="Basics"));

  final parameter String directoryPath=Modelica.Utilities.Files.loadResource("modelica://ClaRa_Solar/Resources/InputData/InputIrradiation/Directory_File.txt")
                                                                                                                                                        "Path of radiation data" annotation(Dialog(group="Basics"));
  final parameter String path=Modelica.Utilities.Files.splitPathName(directoryPath);
...
//Initialization
  ...
  ClaRa.Basics.ControlVolumes.SolidVolumes.CylindricalThinWall_L4
    ...
    diameter_i=d_i,
    length=L,
    T_start=ones(nNodes)*(273.15 + 220))
         annotation (Placement(transformation(extent={{54,-22},{74,-14}})));
  Components.Absorber.Parabolic.ParabolSolarlite parabolSolarliteThailand(
    L=L,
    n_ax=nNodes,
    W=W,
    dx=tube1.Delta_x,
    n_Qrad_ax=n_Qrad_Evap) annotation (Placement(transformation(extent={{14,40},{34,60}})));
  ...
  ClaRa.Basics.ControlVolumes.SolidVolumes.CylindricalThinWall_L4
    ...
    diameter_i=d_iSH,
    length=LSH,
    T_start=ones(nNodesSH)*(273.15 + 280))
         annotation (Placement(transformation(extent={{-240,-22},{-220,-14}})));
  Components.Absorber.Parabolic.ParabolSolarlite parabolSolarliteThailand1(
    L=L,
    n_ax=nNodes,
    W=W,
    dx=tube.Delta_x,
    n_Qrad_ax=n_Qrad_Evap) annotation (Placement(transformation(extent={{14,-20},{34,0}})));
  Modelica.Blocks.Sources.Constant const1(
                                         k=0)
    annotation (Placement(transformation(extent={{-6,0},{14,20}})));
  Components.Absorber.Parabolic.ParabolSolarlite parabolSolarliteThailand2(
    W=W,
    L=LSH,
    n_ax=nNodesSH,
    dx=tubeSH.Delta_x,
    n_Qrad_ax=n_Qrad_SH) annotation (Placement(transformation(extent={{-268,-20},{-248,0}})));
  ...
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable2(
    tableOnFile=true,
    tableName="dat",
    fileName=path + "SuperheaterLoop1.txt",
    columns=2:n_Qrad_SH + 1)
    annotation (Placement(transformation(extent={{-300,-20},{-280,0}})));
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable4(
    tableOnFile=true,
    tableName="dat",
    fileName=path + "EvaporatorLoop2.txt",
    columns=2:n_Qrad_Evap + 1)
    annotation (Placement(transformation(extent={{-26,40},{-6,60}})));
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable1(
    tableOnFile=true,
    tableName="dat",
    fileName=path + "EvaporatorLoop1.txt",
    columns=2:n_Qrad_Evap + 1)
    annotation (Placement(transformation(extent={{-26,-20},{-6,0}})));

  Components.Absorber.Parabolic.ParabolSolarlite parabolSolarliteThailand3(
    L=L,
    n_ax=nNodes,
    W=W,
    dx=tube1.Delta_x,
    n_Qrad_ax=n_Qrad_Evap) annotation (Placement(transformation(extent={{14,100},{34,120}})));
  ...
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable3(
    tableOnFile=true,
    tableName="dat",
    fileName=path + "EvaporatorLoop3.txt",
    columns=2:n_Qrad_Evap + 1)
    annotation (Placement(transformation(extent={{-26,100},{-6,120}})));

  Components.Absorber.Parabolic.ParabolSolarlite parabolSolarliteThailand4(
    L=L,
    n_ax=nNodes,
    W=W,
    dx=tube1.Delta_x,
    n_Qrad_ax=n_Qrad_Evap) annotation (Placement(transformation(extent={{14,160},{34,180}})));
  Modelica.Blocks.Sources.Constant const4(
                                         k=0)
    annotation (Placement(transformation(extent={{-6,180},{14,200}})));
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable5(
    tableOnFile=true,
    tableName="dat",
    fileName=path + "EvaporatorLoop4.txt",
    columns=2:n_Qrad_Evap + 1)
  ...
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTableSH2(
    tableOnFile=true,
    tableName="dat",
    fileName=path + "SuperheaterLoop2.txt",
    columns=2:n_Qrad_SH + 1)
  ...
  Components.Absorber.Parabolic.ParabolSolarlite parabolSolarliteThailand6(
    W=W,
    L=LSH,
    n_ax=nNodesSH,
    dx=tubeSH.Delta_x,
    n_Qrad_ax=n_Qrad_SH) annotation (Placement(transformation(extent={{-268,120},{-248,140}})));
  Modelica.Blocks.Sources.Constant const6(
                                         k=0)
    annotation (Placement(transformation(extent={{-290,150},{-270,170}})));
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTableSH1(
    tableOnFile=true,
    tableName="dat",
    fileName=path + "SuperheaterLoop3.txt",
    columns=2:n_Qrad_SH + 1)
    annotation (Placement(transformation(extent={{-300,120},{-280,140}})));
  Components.Absorber.Parabolic.ParabolSolarlite parabolSolarliteThailand7(
    L=L,
    n_ax=nNodes,
    W=W,
    dx=tube1.Delta_x,
    n_Qrad_ax=n_Qrad_Evap) annotation (Placement(transformation(extent={{14,220},{34,240}})));
  Modelica.Blocks.Sources.Constant const7(
                                         k=0)
    annotation (Placement(transformation(extent={{-6,240},{14,260}})));
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable6(
    tableOnFile=true,
    tableName="dat",
    fileName=path + "EvaporatorLoop5.txt",
    columns=2:n_Qrad_Evap + 1)
    annotation (Placement(transformation(extent={{-26,220},{-6,240}})));
  Components.Absorber.Parabolic.ParabolSolarlite parabolSolarliteThailand8(
    L=L,
    n_ax=nNodes,
    W=W,
    dx=tube1.Delta_x,
    n_Qrad_ax=n_Qrad_Evap) annotation (Placement(transformation(extent={{14,280},{34,300}})));
  Modelica.Blocks.Sources.Constant const8(
                                         k=0)
    annotation (Placement(transformation(extent={{-6,300},{14,320}})));
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable7(
    tableOnFile=true,
    tableName="dat",
    fileName=path + "EvaporatorLoop6.txt",
    columns=2:n_Qrad_Evap + 1)
  ...
  ClaRa.Basics.ControlVolumes.SolidVolumes.CylindricalThinWall_L4
    ...
    diameter_o=d_a,
    diameter_i=d_i,
    length=L,                                                                                                     T_start=ones(nNodes)*(273.15 + 220))
  ...
  ClaRa.Components.VolumesValvesFittings.Pipes.PipeFlowVLE_L4_Simple tubeSH1(
    ...
    N_cv=nNodesSH) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-230,40})));
  Components.Absorber.Parabolic.ParabolSolarlite parabolSolarliteThailand5(
    W=W,
    L=LSH,
    n_ax=nNodesSH,
    dx=tubeSH.Delta_x,
    n_Qrad_ax=n_Qrad_SH) annotation (Placement(transformation(extent={{-268,50},{-248,70}})));
  ClaRa.Basics.ControlVolumes.SolidVolumes.CylindricalThinWall_L4
                                                  wallSH2(
    redeclare replaceable model Material = TILMedia.SolidTypes.TILMedia_Steel,
    N_ax=nNodesSH,
  ...
  ClaRa.Visualisation.Quadruple quadruple2 annotation (Placement(transformation(extent={{-242,20},{-218,32}})));
...
equation
  connect(const.y, parabolSolarliteThailand.Alpha) annotation (Line(
      points={{15,70},{18.6,70},{18.6,60}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(const1.y, parabolSolarliteThailand1.Alpha)
                                                   annotation (Line(
      points={{15,10},{18.6,10},{18.6,0}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(const2.y, parabolSolarliteThailand2.Alpha)
                                                   annotation (Line(
      points={{-271,20},{-263.4,20},{-263.4,0}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(combiTimeTable2.y, parabolSolarliteThailand2.Q_radiation) annotation (
     Line(
      points={{-279,-10},{-268,-10}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(combiTimeTable4.y, parabolSolarliteThailand.Q_radiation) annotation (
      Line(
      points={{-5,50},{14,50}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(combiTimeTable1.y, parabolSolarliteThailand1.Q_radiation) annotation (
     Line(
      points={{-5,-10},{14,-10}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(combiTimeTable3.y, parabolSolarliteThailand3.Q_radiation) annotation (
     Line(
      points={{-5,110},{14,110}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(const3.y, parabolSolarliteThailand3.Alpha) annotation (Line(
      points={{15,130},{18.6,130},{18.6,120}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(const4.y, parabolSolarliteThailand4.Alpha) annotation (Line(
      points={{15,190},{18.6,190},{18.6,180}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(combiTimeTable5.y, parabolSolarliteThailand4.Q_radiation) annotation (
     Line(
      points={{-5,170},{14,170}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(PIDValveBranch1.y, valveBranch.opening_in) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(const6.y,parabolSolarliteThailand6. Alpha)
                                                   annotation (Line(
      points={{-269,160},{-263.4,160},{-263.4,140}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(combiTimeTableSH1.y,parabolSolarliteThailand6. Q_radiation)
                                                                    annotation (
     Line(
      points={{-279,130},{-268,130}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(const7.y,parabolSolarliteThailand7. Alpha) annotation (Line(
      points={{15,250},{18.6,250},{18.6,240}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(combiTimeTable6.y,parabolSolarliteThailand7. Q_radiation) annotation (
     Line(
      points={{-5,230},{14,230}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(const8.y,parabolSolarliteThailand8. Alpha) annotation (Line(
      points={{15,310},{18.6,310},{18.6,300}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(combiTimeTable7.y,parabolSolarliteThailand8. Q_radiation) annotation (
     Line(
      points={{-5,290},{14,290}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(wall.innerPhase, tube.heat) annotation (Line(
      ...
      color={167,25,48},
      thickness=0.5));
  connect(wall.outerPhase, parabolSolarliteThailand1.port) annotation (Line(
  ...
  connect(tube1.inlet, valveBranch1.outlet) annotation (Line(
      ...
      pattern=LinePattern.Solid,
      thickness=0.5));
  connect(wall1.outerPhase, parabolSolarliteThailand.port) annotation (Line(
  ...
  connect(valveBranch2.outlet, tube2.inlet) annotation (Line(
      ...
      pattern=LinePattern.Solid,
      thickness=0.5));
  connect(wall2.outerPhase, parabolSolarliteThailand3.port) annotation (Line(
  ...
  connect(valveBranch3.outlet, tube3.inlet) annotation (Line(
      ...
      pattern=LinePattern.Solid,
      thickness=0.5));
  connect(wall3.outerPhase, parabolSolarliteThailand4.port) annotation (Line(
  ...
  connect(tube4.inlet, valveBranch4.outlet) annotation (Line(
      ...
      pattern=LinePattern.Solid,
      thickness=0.5));
  connect(wall4.outerPhase, parabolSolarliteThailand7.port) annotation (Line(
  ...
  connect(tube5.inlet, valveBranch5.outlet) annotation (Line(
      ...
      pattern=LinePattern.Solid,
      thickness=0.5));
  connect(wall5.outerPhase, parabolSolarliteThailand8.port) annotation (Line(
  ...
  connect(tubeSH.heat, wallSH.innerPhase) annotation (Line(
      ...
      color={167,25,48},
      thickness=0.5));
  connect(wallSH.outerPhase, parabolSolarliteThailand2.port) annotation (Line(
  ...
  connect(join_Y7.inlet2, tubeSH1.outlet) annotation (Line(
      ...
      pattern=LinePattern.Solid,
      thickness=0.5));
  connect(combiTimeTableSH2.y, parabolSolarliteThailand5.Q_radiation) annotation (Line(points={{-279,60},{-268,60}}, color={0,0,127}));
  connect(const5.y, parabolSolarliteThailand5.Alpha) annotation (Line(points={{-269,90},{-263.4,90},{-263.4,70}}, color={0,0,127}));
  connect(wallSH1.outerPhase, parabolSolarliteThailand5.port) annotation (Line(
  ...
  connect(tubeSH2.heat, wallSH2.innerPhase) annotation (Line(
      ...
      color={167,25,48},
      thickness=0.5));
  connect(wallSH2.outerPhase, parabolSolarliteThailand6.port) annotation (Line(
  ...
  connect(quadruple2.eye, tubeSH1.eye) annotation (Line(points={{-242,26},{-244.6,26},{-244.6,36.6}}, color={190,190,190}));
...
end SixBranchesEvapThreeBranchsSH_Turbine;
