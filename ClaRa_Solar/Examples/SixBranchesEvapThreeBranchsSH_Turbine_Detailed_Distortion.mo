...
model SixBranchesEvapThreeBranchsSH_Turbine_Detailed_Distortion
...
//Sun
  ...
  Components.SunModels.Sun sun(
    ...
    L=LLat,
    LL=LLong,
    Green=Green) annotation (Placement(transformation(extent={{44,306},{24,326}})));
  Components.SunModels.Sun sun1(
    ...
    L=LLat,
    LL=LLong,
    Green=Green) annotation (Placement(transformation(extent={{44,246},{24,266}})));
  Components.SunModels.Sun sun2(
    ...
    L=LLat,
    LL=LLong,
    Green=Green) annotation (Placement(transformation(extent={{44,186},{24,206}})));
  Components.SunModels.Sun sun3(
    ...
    L=LLat,
    LL=LLong,
    Green=Green) annotation (Placement(transformation(extent={{44,124},{24,144}})));
  Components.SunModels.Sun sun4(
    ...
    L=LLat,
    LL=LLong,
    Green=Green) annotation (Placement(transformation(extent={{44,64},{24,84}})));
  Components.SunModels.Sun sun5(
    ...
    L=LLat,
    LL=LLong,
    Green=Green) annotation (Placement(transformation(extent={{44,4},{24,24}})));
  Components.SunModels.Sun sun6(
    ...
    L=LLat,
    LL=LLong,
    Green=Green) annotation (Placement(transformation(extent={{-226,142},{-246,162}})));
  Components.SunModels.Sun sun7(
    ...
    L=LLat,
    LL=LLong,
    Green=Green) annotation (Placement(transformation(extent={{-228,72},{-248,92}})));
  Components.SunModels.Sun sun8(
    ...
    L=LLat,
    LL=LLong,
    Green=Green) annotation (Placement(transformation(extent={{-228,2},{-248,22}})));
equation
  ...
  connect(const2.y, parabolSolarliteDetailled7.Alpha) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(combiTimeTable2.y, parabolSolarliteDetailled7.Q_radiation) annotation (Line(
      points={{-279,-10},{-268,-10}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(combiTimeTable4.y, parabolSolarliteDetailled5.Q_radiation) annotation (Line(
      points={{-5,50},{14,50}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(combiTimeTable1.y, parabolSolarliteDetailled1.Q_radiation) annotation (Line(
      points={{-5,-10},{14,-10}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(combiTimeTable3.y, parabolSolarliteDetailled4.Q_radiation) annotation (Line(
      points={{-5,110},{14,110}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(const4.y, parabolSolarliteDetailled3.Alpha) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(combiTimeTable5.y, parabolSolarliteDetailled3.Q_radiation) annotation (Line(
      points={{-5,170},{14,170}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(const6.y, parabolSolarliteDetailled6.Alpha) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(combiTimeTableSH1.y, parabolSolarliteDetailled6.Q_radiation) annotation (Line(
  ...
  connect(const7.y, parabolSolarliteDetailled2.Alpha) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(combiTimeTable6.y, parabolSolarliteDetailled2.Q_radiation) annotation (Line(
      points={{-5,230},{14,230}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(const8.y,parabolSolarliteDetailled. Alpha) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(combiTimeTable7.y,parabolSolarliteDetailled. Q_radiation) annotation (
     Line(
      points={{-5,290},{14,290}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(join_Y7.inlet2, tubeSH1.outlet) annotation (Line(
      ...
      pattern=LinePattern.Solid,
      thickness=0.5));
  connect(combiTimeTableSH2.y, parabolSolarliteDetailled8.Q_radiation) annotation (Line(points={{-279,60},{-268,60}}, color={0,0,127}));
  ...
  connect(parabolSolarliteDetailled.SunIn, sun.y) annotation (Line(points={{19,300},{19,310},{23,310}}, color={0,0,127}));
  connect(parabolSolarliteDetailled2.SunIn, sun1.y) annotation (Line(points={{19,240},{19,250},{23,250}}, color={0,0,127}));
  connect(sun2.y, parabolSolarliteDetailled3.SunIn) annotation (Line(points={{23,190},{19,190},{19,180}}, color={0,0,127}));
...
end SixBranchesEvapThreeBranchsSH_Turbine_Detailed_Distortion;
