within ClaRa_Solar.Components.Absorber.StaticCycle;
model Parapolic_Tube " Parabolic Tube || blue | blue"
...
//__________________________________________________________________________//
  ...
  parameter ClaRa.Basics.Units.EnthalpyMassSpecific Delta_h_nom=0 "Nominal enthalpy difference" annotation (Dialog(group="Fundamental Definitions"));
  ...
  final parameter ClaRa.Basics.Units.EnthalpyMassSpecific h_out = h_in + Delta_h_nom "Outlet enthalpy";
...
public
  ClaRa.StaticCycles.Fundamentals.SteamSignal_blue_a inlet(p=p_in, Medium=medium) annotation (Placement(transformation(extent={{-100,-10},{-110,10}}), iconTransformation(extent={{-100,-10},{-110,10}})));
  ClaRa.StaticCycles.Fundamentals.SteamSignal_blue_b outlet(m_flow=m_flow, h=h_out, Medium=medium) annotation (Placement(transformation(extent={{110,-10},{100,10}}), iconTransformation(extent={{110,-10},{100,10}})));
initial equation
